...
},{"throttle-debounce":"../node_modules/throttle-debounce/dist/index.esm.js","./Events":"scripts/Events.ts"}],"scripts/algorithms/char-frequency/_calc-frequency.ts":[function(require,module,exports) {
"use strict";
...
},{"./algorithms/char-frequency/calc-char-pair-frequency":"scripts/algorithms/char-frequency/calc-char-pair-frequency.ts","./algorithms/char-frequency/calc-char-frequency":"scripts/algorithms/char-frequency/calc-char-frequency.ts","./Events":"scripts/Events.ts"}],"../node_modules/moment/moment.js":[function(require,module,exports) {
var define;
...
},{"moment":"../node_modules/moment/moment.js"}],"scripts/Res.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Res.prototype.update = function () {
    this.updateCharChart();
    this.updatePairChart();
    this.updateSummary();
  };

  Res.prototype.initEvents = function () {
    var _this = this;

    this.frequency.events.addListener('update', function () {
      _this.update();
    });
  };
  ...
  Res.prototype.updateCharChart = function () {
    ...
    this.charChart = new chart_js_1.default(this.charCtx, {
      type: 'bar',
      data: {
        labels: labels,
        datasets: [{
...
exports.default = Res;
},{"chart.js":"../node_modules/chart.js/dist/Chart.js"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var Res_1 = __importDefault(require("./scripts/Res"));
...
var res = new Res_1.default($.res, frequency);
var update = throttle_debounce_1.debounce(500, function () {
  updateFrequency();
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "45193" + '/');
